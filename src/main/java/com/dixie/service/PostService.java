...
public interface PostService {
    ...
    CompletableFuture<String> uploadImagerPost(String imagerPostUploadInfo, MultipartFile image) throws URISyntaxException, IOException, ExecutionException, InterruptedException;
